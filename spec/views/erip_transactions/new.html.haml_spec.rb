...
RSpec.describe "erip_transactions/new", type: :view do
  before(:each) do
    assign(:erip_transaction, EripTransaction.new(
      :status => "MyString",
      :message => "MyString",
      :type => "",
  ...
  it "renders new erip_transaction form" do
    render

    assert_select "form[action=?][method=?]", erip_transactions_path, "post" do
